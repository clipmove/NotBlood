...
* Enemy behavior (NotBlood)
   ...
   - Allow enemies to path across horizontal-aligned sprites (bridges)
...
* cl_automedkit
   - Enable/disable automatic medkit healing
...
* hud_secretstyle
   - Set secrets message style (0: original, 1: notblood, 2: gzdoom)
* hud_stats
...
* hud_powerupdurationshowdivingsuit
   - Enable/disable diving suit as a power-up
