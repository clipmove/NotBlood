...
//        { "cl_weaponsway", "enable/disable player weapon swaying", (void *)&ud.weaponsway, CVAR_BOOL, 0, 1 },
        ...
        { "color", "set preferred player color palette in multiplayer (0: none, 1: blue, 2: red, 3: teal, 4: gray, 5: gold, 6: brown, 7: rust)", (void *)&gPlayerColorPreference, CVAR_INT, 0, 7 },
//
