...
//        { "snd_ambience", "enables/disables ambient sounds", (void *)&ud.config.AmbienceToggle, CVAR_BOOL, 0, 1 },
        ...
        { "snd_dingkill", "enable/disable kill noise when killing another player. the sound can be changed by replacing the 'notblood.pk3/NOTKILL.RAW' file", (void*)&gSoundDingKill, CVAR_BOOL, 0, 1 },
