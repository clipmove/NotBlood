...
//
        ...
        { "in_radialmenumousethreshold", "sets the radial menu mouse sensitivity", (void*)&gRadialMenuMouseSensitivity, CVAR_INT, fix16_from_float(0.1), fix16_from_float(3.f)},
