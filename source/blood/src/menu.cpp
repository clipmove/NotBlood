...
CGameMenuItemZBool itemNetGameBoolPlayerColors("PLAYER COLORS:", 3, 66, 89, 180, true, 0, "EXTENDED", "VANILLA");
...
CGameMenuItemZBool itemNetGameBoolTeamColors("TEAM COLORS:", 3, 66, 89, 180, true, 0, NULL, NULL);
