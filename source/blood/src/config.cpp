...
int32_t gRadialMenuMouseSensitivity;
int32_t gRadialMenuThresholdX;
int32_t gRadialMenuThresholdY;
...
int32_t gShowDamage;
int32_t gShowDamageTicks;
int32_t gShowDamageX;
int32_t gShowDamageY;
int32_t gShowSpeed;
int32_t gHudRatio;
...
int gEnemyRandomTNT;
int gWeaponsVer;
int gWeaponImpulseLimit;
int gAmmoScale;
int gSectorBehavior;
int gHitscanProjectiles;
int gGoreBehavior;
int gPlayerModSpeed;
int gPlayerModWaterOxygen;
int gRandomizerMode;
...
const char *gPlayerNames[kMaxPlayers] =
{
    "Caleb",
    "Cultist",
    "Gargoyle",
...
void CONFIG_SetDefaultPlayerName()
{
...
# endif
    ...
    gRadialMenuDimHud = 1;
    gRadialMenuMouseSensitivity = 65536;
    ...
    gEnemyRandomTNT = 0;
    gWeaponsVer = 0;
    gWeaponImpulseLimit = 0;
    gAmmoScale = 0;
    gSectorBehavior = 0;
    gHitscanProjectiles = 0;
    gGoreBehavior = 0;
    gPlayerModSpeed = 0;
    gPlayerModWaterOxygen = 0;
    gRandomizerMode = 0;
...
int CONFIG_ReadSetup(void)
{
    ...
    SCRIPT_GetNumber(scripthandle, "Game Options", "WeaponImpulseLimit", &gWeaponImpulseLimit);
    ...
    SCRIPT_GetNumber(scripthandle, "Game Options", "PlayerModWaterOxygen", &gPlayerModWaterOxygen);
...
void CONFIG_WriteSetup(uint32_t flags)
{
    ...
    SCRIPT_PutNumber(scripthandle, "Game Options", "WeaponImpulseLimit", gWeaponImpulseLimit, FALSE, FALSE);
    ...
    SCRIPT_PutNumber(scripthandle, "Game Options", "PlayerModWaterOxygen", gPlayerModWaterOxygen, FALSE, FALSE);
